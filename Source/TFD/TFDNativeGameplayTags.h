...
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Character_State_SpeedUp); //스킬-스피드업
...
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Ability_SpeedUp); //스킬-스피드업
...
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Object_PickupItem);			//스킬-겸용-줍는 아이템
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Object_ThrowableItem);		//스킬-겸용-던지는 아이템
...
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Object_SpawnPoint_Period_SkillItem);
...
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Cooldown_Ability_SpeedUp); //스킬-스피드업
