...
#include "Object/Discard/TFDSlowObject.h"
...
void ATFDSlowObject::BeginPlay()
{
	Super::BeginPlay();
	CollisionComp->OnComponentBeginOverlap.AddDynamic(this, &ATFDSlowObject::OnOverlapBegin);
}

void ATFDSlowObject::OnOverlapBegin(UPrimitiveComponent* OverlappedComp, AActor* OtherActor,
                                    ...
                                    const FHitResult& SweepResult)
{
	...
	if (ATFDCharacter* Player = Cast<ATFDCharacter>(OtherActor))
	{
		...
		if (UAbilitySystemComponent* ASC = Player->GetAbilitySystemComponent())
		{
			...
			{
				ASC->ApplyGameplayEffectToSelf(AppliedGameplayEffect.GetDefaultObject(), 1.f, ASC->MakeEffectContext());
				Destroy();
			}
		}
	}
...
// Called every frame
void ATFDSlowObject::Tick(float DeltaTime)
{
