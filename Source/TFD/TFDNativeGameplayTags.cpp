...
UE_DEFINE_GAMEPLAY_TAG(TAG_Character_State_SpeedUp, "Character.State.SpeedUp"); //스킬-스피드업
...
UE_DEFINE_GAMEPLAY_TAG(TAG_Ability_SpeedUp, "Ability.SpeedUp"); //스킬-스피드업
...
UE_DEFINE_GAMEPLAY_TAG(TAG_Object_PickupItem, "Object.PickupItem");						//스킬-겸용-줍는 아이템
UE_DEFINE_GAMEPLAY_TAG(TAG_Object_ThrowableItem, "Object.ThrowableItem");				//스킬-겸용-던지는 아이템
...
UE_DEFINE_GAMEPLAY_TAG(TAG_Object_SpawnPoint_Period_SkillItem, "Object.SpawnPoint.Period.SkillItem"); //스폰포인트
...
UE_DEFINE_GAMEPLAY_TAG(TAG_GameplayCue_Character_Release, "GameplayCue.Character.Release");
...
UE_DEFINE_GAMEPLAY_TAG(TAG_Cooldown_Ability_SpeedUp, "Cooldown.Ability.SpeedUp"); //스킬-스피드업
